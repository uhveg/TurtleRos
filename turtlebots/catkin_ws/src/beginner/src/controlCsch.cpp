...
int main(int argc, char **argv)
{
    ...
    Turtlebot_Ctrl tbots[] = {
        Turtlebot_Ctrl(nh_, "bot3", -1.5, 0, 0.0, true),
        Turtlebot_Ctrl(nh_, "bot6", -0.5, 0, 0.0, true),
        Turtlebot_Ctrl(nh_, "bot7", 0.5, 0, 0.0, true),
        Turtlebot_Ctrl(nh_, "bot9", 1.5, 0, 0.0, true)
    };
